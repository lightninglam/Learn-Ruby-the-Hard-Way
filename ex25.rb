module Ex25
  ...
  def Ex25.print_first_word(words)
    #.shift takes an array (list of words), removes the first element, and retunrs it
    word = words.shift
    puts word
  end
  ...
  def Ex25.sort_sentence(sentence)
    #break the sentence into and array of words
  ...
  def Ex25.print_first_and_last_sorted(sentence)
    ...
    #call the print_first_word function on the sorted array
    Ex25.print_first_word(words)
    #call the print_last_word function on the sorted array
    Ex25.print_last_word(words)
  end
